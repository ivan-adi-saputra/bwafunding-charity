    ...
    <!-- <section class="xs-welcome-slider">
        <div class="xs-banner-slider owl-corousel">
            <div class="xs-welcome-content" style="background-image: url(assets/images/slide1.png);">
                <div class="container">
                    <div class="xs-welcome-wraper color-white">
                        ...
                        <a href="#popularcause" class="btn btn-outline-primary">View Causes</a>
                    </div>
                </div>
    ...
    <section class="xs-welcome-slider">
        ...
        <div class="xs-banner-slider owl-carousel owl-loaded owl-drag">
    ...
    <!-- <section class="xs-welcome-slider">
        ...
        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1278px, 0px, 0px); transition: all 0s ease 0s; width: 4476px;"><div class="owl-item cloned" style="width: 639.333px;"><div class="xs-welcome-content" style="background-image: url(assets/images/slide2.png);">
                <div class="container">
                    <div class="xs-welcome-wraper color-white">
                        <h2>Let's free the nature at all</h2>
                        <p>Hundreds of thousands of children experiencing or witnessing assault <br> and other
                ...
                <div class="xs-black-overlay"></div>
            </div></div><div class="owl-item cloned" style="width: 639.333px;"><div class="xs-welcome-content" style="background-image: url(assets/images/slide3.png);">
                <div class="container">
                    <div class="xs-welcome-wraper color-white">
                        <h2>Help us in big mission to rescue</h2>
                        <p>Hundreds of thousands of children experiencing or witnessing assault <br> and other
